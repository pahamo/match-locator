...
SELECT
  ...
  -- Select first England broadcaster alphabetically by channel name
  -- Country codes: EN (England, 462), GB/GBR (legacy)
  -- Note: Ireland (IE, 455) has different broadcasters, not included
  (
